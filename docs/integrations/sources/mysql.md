...
|:------------|:-----------|:-----------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.53.5      | 2026-09-11 | [85846](https://github.com/airbytehq/airbyte/issues/85846) | Promote to Bulk CDK 1.2.0: support MySQL 8.4 tagged GTIDs, which previously failed every CDC sync against servers using them (e.g. InnoDB Cluster). |
